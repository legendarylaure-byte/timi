...
- **Stack**: Match the project's framework.

### Step 2: Use Quick Reference

Consult the Quick Reference sections above based on what you're building:
- New page → §5 Layout & Responsive
- New component → §4 Style Selection
- Accessibility review → §1 Accessibility
- Animations → §7 Animation
- Forms → §8 Forms & Feedback
- Navigation → §9 Navigation Patterns
- Charts → §10 Charts & Data

### Step 3: Apply Pre-Delivery Checklist
