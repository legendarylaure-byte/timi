...
const perks = [
  { icon: '✨', title: '9 AI Agents', desc: 'Script to publish, automated' },
  { icon: '🚀', title: 'Daily Content', desc: 'Shorts + long-form videos' },
  { icon: '💎', title: '100% Free', desc: 'Local AI, no API costs' },
];
      ...
      >
        ...
        >
          ...
          <p className="text-lg text-stone-600 mb-8 max-w-md mx-auto lg:mx-0">
            Create, automate, and publish AI-generated videos to YouTube and beyond.
          </p>
          ...
          <div className="space-y-3 max-w-sm mx-auto lg:mx-0">
            {perks.map((perk, i) => (
              <motion.div
                ...
                className="flex items-center gap-4 p-3 rounded-xl bg-white/60 border border-orange-200/40 backdrop-blur-sm"
              >
                <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-orange-200/50 to-pink-200/50 flex items-center justify-center text-xl">
                  {perk.icon}
                </div>
                <div>
                  <h3 className="text-sm font-semibold text-stone-800">{perk.title}</h3>
        ...
        >
          <div className="relative rounded-3xl overflow-hidden" style={{
            ...
            <div className="relative z-10 p-8 sm:p-10">
              <h2 className="text-2xl font-bold text-stone-800 mb-2">Get Started</h2>
              <p className="text-sm text-stone-500 mb-8">Create your account and start creating</p>
