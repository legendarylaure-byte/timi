...
def load_recent_performance(days: int = 7) -> str:
    ...
    lines.append(f"Videos by character: {json.dumps(by_character)}")
...
def create_analyst_crew():
    ...
    analyst = Agent(
        ...
        backstory="""You are a data-driven content strategist specializing in children's YouTube channels.
You analyze engagement metrics, quality scores, and performance trends to identify
what content resonates best with young audiences. Your insights help the creative team
optimize future videos for maximum engagement and educational impact.""",
    ...
    analysis_task = Task(
        description="""Analyze the following performance data for a children's educational YouTube channel
...
1. **Top Performers**: Which content types/categories/characters perform best?
...
Return as JSON:
{
  ...
  "top_performers": {
    ...
    "best_character": "<character name or 'N/A'>",
